...
export default function RecommendationsRow({ mediaType, items }: { mediaType: "movie"|"tv"; items: TmdbShow[] }) {
  if (!items.length) return null;
  return (
    <section className="space-y-[var(--space-3)]">
      <h2 className="text-lg font-medium pl-[var(--space-3)] border-l-4 border-[color:var(--color-accent)]">Recommended</h2>
